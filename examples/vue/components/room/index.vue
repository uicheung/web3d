<template>
    ...
    <div class="map">
      ...
      <img src="../../../../static/img/map.gif" alt="" />
    </div>
  ...
  import SpriteCanvas from "../../handle/SpriteCanvas";
  ...
  class Room {
    constructor(
      ...
      arr.forEach((item) => {
        // 纹理加载
        let texture = new THREE.TextureLoader().load(`./static/${textureUrl}/${item}.jpg`);
        // 创建材质
